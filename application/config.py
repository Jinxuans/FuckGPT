...
class ConfigService:
    ...
    def get_options(self) -> dict:
        ...
        return {
            ...
            "proxy_providers": self.provider_definitions.list_definitions("proxy", enabled_only=False),
            "push_providers": self.provider_definitions.list_definitions("push", enabled_only=True),
            ...
            "push_drivers": self.provider_definitions.list_driver_templates("push"),
            ...
            "push_settings": self.provider_settings.list_settings("push"),
            **platform_options,
        }
